...
<head>
    ...
    <style type="text/css">
        ...
        #color-landing-page .static-header.FeaturesMain-0 {
            background: url('https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/bg/startup-02.jpg') no-repeat center center;
    ...
    <div id="hero" class="static-header light inverted clearfix FeaturesMain-0">
        <div class="text-heading">
            ...
            <p class="animated hiding p-sub" data-animation="fadeInDown" data-delay="500">
				VNOC allows you to create your own monetization program with core monetization tools that will help you control your strategy the way you or your company likes it.
			</p>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        MONETIZATION <span class="highlight">TRACKER</span>
                                    </h3>
                                    <div class="sub-title">
                                        VNOC allows you to add your favorite monetization site and its process.
                                    </div>
                                    <br>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="MONETIZATION-TRACKER" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/monetization/MONETIZATION-TRACKER-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>

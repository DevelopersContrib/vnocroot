...
<head>
    ...
    <style type="text/css">
        ...
        #color-landing-page .static-header.FeaturesMain-0 {
            background: url('https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/bg/startup.jpg') no-repeat center center;
    ...
    <div id="hero" class="static-header light inverted clearfix FeaturesMain-0">
        <div class="text-heading">
            ...
            <p class="animated hiding p-sub" data-animation="fadeInDown" data-delay="500">
				Communicating with your target market and visitors in real time or in drip segmentation is one of the most important feature in VNOC.  We have a set of simple tools to let you do this.
			</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Autoresponder" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/communication/Autoresponder-1.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        Team <span class="highlight">CHATTER</span>
                                    </h3>
                                    <div class="sub-title">
                                        Team chatter is a simple way for teams to collaborate and communicate. It allows you to post to your brands network of contributors and allows you to get snapshots of tasks done or new contributions made.
                                    </div>
                                    <br>
                                    <a data-delay="700" data-animation="bounceIn" class="btn btn-secondary animated bounceIn visible" href="https://www.contrib.com">Go to Contrib</a>
                                </article>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Team-Chatter" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/communication/Team-Chatter-1.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        VERTICAL <span class="highlight">MAIL</span>
                                    </h3>
                                    <div class="sub-title">
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Vertical-Mail" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/communication/Vertical-Mail-1.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    ...
                                    <div class="sub-title">
                                        Integrations with Slack, HipChat, via Brand apps and core integrations with Sendgrid allows us to
                                        communicate with our team, our customers and our contributors.
                                    </div>
                                    <br>
                                    <a data-delay="700" data-animation="bounceIn" class="btn btn-secondary animated bounceIn visible" href="https://www.contrib.com">Go to Contrib</a>
                                </article>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Integrations" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/communication/Integrations-1.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Portability" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/communication/Portability-1.jpg">
                            </div>
                        </div>
                    </div>
                </div>

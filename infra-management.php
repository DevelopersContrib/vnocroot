...
<head>
    ...
    <style type="text/css">
        ...
        #color-landing-page .static-header.FeaturesMain-0 {
            background: url('https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/bg/conference-room.jpg') no-repeat center center;
    ...
    <div id="hero" class="static-header light inverted clearfix FeaturesMain-0">
        <div class="text-heading">
            <h1 class="animated hiding ttle-header" data-animation="bounceInDown" data-delay="0">
                Network and Infra Management
            </h1>
            <p class="animated hiding p-sub" data-animation="fadeInDown" data-delay="500">
				VNOC allows you to fully manage your brands, your network and your infrastructure. We allow you to add your servers and allow us to manage them or give us ample access to build your brands with.
			</p>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        MANAGE YOUR <span class="highlight">INFRASTRUCTURE</span>
                                    </h3>
                                    <div class="sub-title">
                                        You want to control your setup. Fine with us. You want to control your infrastructure. Thats great and then we let you do it.
                                    </div>
                                    <br>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="INFRASTRUCTURE-MANAGEMENT" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/infra/INFRASTRUCTURE-MANAGEMENT-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        FRAMEWORK <span class="highlight">MANAGEMENT</span>
                                    </h3>
                                    <div class="sub-title">
                                        Our frameworks are battle-tested and works to convert your visitors to contributors with integrated apps and process from both Contrib and VNOC - lead capture, analytics, dynamic content.
                                    </div>
                                    <br>
                                    <a data-delay="700" data-animation="bounceIn" class="btn btn-secondary animated bounceIn visible" href="https://www.contrib.com">Go to Contrib</a>
                                </article>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="FRAMEWORK-MANAGEMENT" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/infra/FRAMEWORK-MANAGEMENT-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>

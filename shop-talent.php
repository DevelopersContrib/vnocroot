                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        YOUR OWN <span class="highlight">CONTRIB NETWORK</span>
                                    </h3>
                                    <div class="sub-title">
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Your-own-Contrib-Network" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/shop-talent/Your-own-Contrib-Network-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        INTEGRATED <span class="highlight">MARKETPLACES</span>
                                    </h3>
                                    <div class="sub-title">
                                        We understand that there are specific skills you need, that is why we have integrated skills marketplaces like WriterAccess.com, and Elance.com.
                                    </div>
                                    <br>
                                    <a data-delay="700" data-animation="bounceIn" class="btn btn-secondary animated bounceIn visible" href="https://www.contrib.com">Go to Contrib</a>
                                </article>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="integrated-marketplace" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/shop-talent/integrated-marketplace-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        MULTI POSTING <span class="highlight">SERVICES</span>
                                    </h3>
                                    <div class="sub-title">
                                        Do you have accounts with Third Party job marketplaces like Guru.com, GetAFreelancer or Fiverr? No problem, log your accounts and visit the Multi-Post to Jobs page. Post a Job, then multi-post to these other marketplaces using a simple page syndication.
                                    </div>
                                    <br>
                                    <a data-delay="700" data-animation="bounceIn" class="btn btn-secondary animated bounceIn visible" href="https://www.contrib.com">Go to Contrib</a>
                                </article>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Multi-Posting-Services" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/shop-talent/Multi-Posting-Services-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        ORDER <span class="highlight">eServices</span>
                                    </h3>
                                    <div class="sub-title">
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Order-eServices" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/shop-talent/Order-eServices-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>

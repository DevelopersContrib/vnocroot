...
<head>
    ...
    <style type="text/css">
        ...
        #color-landing-page .static-header.FeaturesMain-0 {
            background: url('https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/bg/student.jpg') no-repeat center center;
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        VERTICAL <span class="highlight">BRANDS SYNERGY</span>
                                    </h3>
                                    <div class="sub-title">
                                        When you add domains and choose their verticals, you are placing all of them and grouping them in multi baskets which allows you and your leaders to vertically organize your portfolio and create a synergy with them when you use any of our portable apps or our frameworks. Handyman.net will have a page that shows our Handyman framework and so on and so forth.
                                    </div>
                                    <br>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Vertical-Brands-Synergy" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/vertical-management/Vertical-Brands-Synergy-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        VERTICAL <span class="highlight">DASHBOARD</span>
                                    </h3>
                                    <div class="sub-title">
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Vertical-Dashboard" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/vertical-management/Vertical-Dashboard-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        VERTICAL <span class="highlight">LEADERS</span>
                                    </h3>
                                    <div class="sub-title">
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Vertical-Leaders" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/vertical-management/Vertical-Leaders-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        VERTICAL <span class="highlight">UPDATES</span>
                                    </h3>
                                    <div class="sub-title">
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Vertical-Updates" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/vertical-management/Vertical-Updates-1.JPG">
                            </div>
                        </div>
                    </div>
                </div>

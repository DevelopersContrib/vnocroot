...
<head>
    ...
    <style type="text/css">
        ...
        #color-landing-page .static-header.FeaturesMain-0 {
            background: url('https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/bg/los-angeles.jpg') no-repeat center center;
    ...
    <div id="hero" class="static-header light inverted clearfix FeaturesMain-0">
        <div class="text-heading">
            ...
            <p class="animated hiding p-sub" data-animation="fadeInDown" data-delay="500">
				Company Feature is the umbrella feature of VNOC. It allows a VNOC member to create a company that houses their domain/s.
			</p>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        COMPANY <span class="highlight">CREATION</span>
                                    </h3>
                                    <div class="sub-title">
                                        VNOC allows you to create companies that houses or is an umbrella to your domain portfolio. Add companies  and manage at will.
                                    </div>
                                    <br>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Company-Creation" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/companies/Company-Creation-1.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        PORTFOLIO <span class="highlight">MANAGEMENT</span>
                                    </h3>
                                    <div class="sub-title">
                                        Within your company, you could have a snapshot of specific updates and statistics important to your organization. This will help you to further manage niche brands within your company.  Add domains by bulk or by single, with teams and auto services and things to do dynamically.
                                    </div>
                                    <br>
                                    <a data-delay="700" data-animation="bounceIn" class="btn btn-secondary animated bounceIn visible" href="https://www.contrib.com">Go to Contrib</a>
                                </article>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Portfolio-Management" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/companies/Portfolio-Management-1.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        COMPANY TEAMS <span class="highlight">MANAGEMENT</span>
                                    </h3>
                                    <div class="sub-title">
                                        When you create or add domains within the company, teams are automatically created with you as the domain owner. Add and invite members of any of your brand team at any time.
                                    </div>
                                    <br>
                                    <a data-delay="700" data-animation="bounceIn" class="btn btn-secondary animated bounceIn visible" href="https://www.contrib.com">Go to Contrib</a>
                                </article>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Company-Teams" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/companies/Company-Teams-Management-1.jpg">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                ...
                                <article class="center">
                                    <h3>
                                        NETWORK <span class="highlight">MANAGEMENT</span>
                                    </h3>
                                    <div class="sub-title">
                                        You and your team have access to your portfolio’s leads whether its from a custom integration, wordpress, or our core frameworks.
                                    </div>
                                    <br>
                                    <a data-delay="700" data-animation="bounceIn" class="btn btn-secondary animated bounceIn visible" href="https://www.contrib.com">Go to Contrib</a>
                                </article>
                            ...
                            <div class="col-sm-6 animated hiding" data-animation="fadeInRight">
                                <img style="height:543px;" alt="Network-Management" src="https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/features/companies/Network-Management-1.jpg">
                            </div>
                        </div>
                    </div>
                </div>

...
<head>
    ...
    <style type="text/css">
        ...
        #color-landing-page .static-header.FeaturesMain-0 {
            background: url('https://d2qcctj8epnr7y.cloudfront.net/images/jayson/vnoc/bg/startup-01.jpg') no-repeat center center;
...
<body id="color-landing-page">
    ...
    <div id="hero" class="static-header light inverted clearfix FeaturesMain-0">
        <div class="text-heading">
            ...
            <p class="animated hiding p-sub" data-animation="fadeInDown" data-delay="500">
				Our platform as a service is suitable for brand management agencies, portfolio owners and small business owners focusing on central management of assets and digital properties.
			</p>
	...
	<h3 class="text-center">
        See our full list of features <a href="https://about.vnoc.com">here</a>
    </h3>
